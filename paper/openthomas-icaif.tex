...
self-improvement cannot redefine ``improvement.'' In a 21-day leak-free replay
against real historical order books with fees (968 settled markets, 2026-06-24 to
07-14), a naked model-vs-market rule barely loses (\$0.007/contract over 425
trades); adding learned station bias and then a market-prior blend turns
expectancy positive (\$0.028/contract) by trading less than half as often (184
trades) --- selectivity, not the model, is the edge, and this is before any of the
live-only advantages are switched on. We report the losing rows as well as the
gains,
